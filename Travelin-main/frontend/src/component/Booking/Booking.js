...
export default function Booking() {
  ...
  async function checkOutHandler(amount) {
    const {
      data: {key},
    } = await axios.get("http://localhost:2000/api/payment/getKey");

    const {
      data: {order},
    } = await axios.post("http://localhost:2000/api/payment/createOrder", {
      amount,
    });
    ...
    const options = {
      ...
      image:
        "https://i.pinimg.com/736x/2f/a2/32/2fa2321cb1703d6eef32410774156fed.jpg",
      order_id: order.id,
          ...
          <div className="col-md-6">
            <div className="form-group mb-2">
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("pfullname", e.target.value, index)
                }
              />
            </div>
          </div>
          <div className="col-md-6">
            <div className="form-group mb-2">
              ...
              <input
                ...
                placeholder="Phone "
                onChange={(e) =>
                  handleInputChange("pmobile", e.target.value, index)
                }
              />
            </div>
          </div>
            ...
            <div className="form-group">
              ...
              <div className="input-box">
                <select
                  ...
                  onChange={(e) =>
                    handleInputChange("pgender", e.target.value, index)
                  }
                >
          ...
          <div className="col-md-6 col-sm-6">
            <div className="form-group mb-2">
              ...
              <input
                ...
                placeholder="Age"
                onChange={(e) =>
                  handleInputChange("page", e.target.value, index)
                }
              />
            </div>
          </div>
              ...
              <div className="cc">
                <div className="booking-box">
                  <div className="customer-information mb-4">
                    <h3 className="border-b pb-2 mb-2">
                  ...
                  <div className="customer-information mb-4 d-flex align-items-center bg-grey rounded p-4 mt-4">
                    ...
                    <div className="customer-info ps-4 ">
                      ...
                      <small>
                        Cancellation is not permitted with this package.
                      </small>
                    </div>
                  </div>
                </div>
                  ...
                  <table>
                    ...
                    <tfoot className="bg-title">
                      <tr>
                        ...
                        <th className="font-weight-bold white">
                          ${price * peopleCount}
                        </th>
                      </tr>
                    </tfoot>
