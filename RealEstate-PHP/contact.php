...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">144,Rajmanidr socity yogichok,surat</span> <br>
										<span class="text-white">122,Apple banglows Dumas ,Surat</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+91 96242 80459</span>
										<span class="text-white">+91 98794 16091 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">ayushsavaliya18@gmail.com</span>
										<span class="text-white">mukundsavsaiya@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
								...
								<form class="w-100" action="#" method="post">
									<div class="row">
										<div class="row mb-4">
											...
											<div class="form-group col-lg-6">
												<input type="text" name="subject"  class="form-control" placeholder="Rent or Buy">
											</div>
											<div class="col-lg-12">
        ...
        <!--	Map -->
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3649099.268365302!2d78.96374546891884!3d20.59368420184444!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a2e4a2a07b08e7f%3A0x10d3e7b0c8e3fd7!2sIndia!5e0!3m2!1sen!2sus!4v1693687883294!5m2!1sen!2sus" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		<!--	Map -->
