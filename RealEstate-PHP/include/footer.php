<footer class="full-row bg-secondary p-0">
    <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4">
                                    <div class="footer-widget">
                                        ...
                                        <ul class="text-white">
                                            <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Mannat, Land's End,mumbai</li>
                                            <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 96242 80459</li>
                                            <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+91 98794 16091
                                            </li>
                                            <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>ayushsavaliya18@gmail.com</li>
                                        </ul>
                                    </div>
                                    <div class="footer-widget media-widget mt-4 text-white hover-text-primary">
                                        <a href="https://www.facebook.com/ayush.savaliya.9461">
                                            <i class="fab fa-facebook-f"></i></a>
                                        <a href="https://x.com/SavaliyaAy64913"><i class="fab fa-twitter"></i></a> <a href="mailto:ayushsavaliya18@gamil.com"><i class="fab fa-google-plus-g"></i></a> <a href="https://www.linkedin.com/in/ayush-savaliya-a26891319/"><i class="fab fa-linkedin-in"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row copyright">
            <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y'); ?> Real Estate Website - Developed By Ayush | Mukund |Raj</span> </div>
            <div class="col-sm-6">
