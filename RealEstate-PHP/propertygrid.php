                                ...
                                ?>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="featured-thumb hover-zoomer mb-4">
                                                        <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/zillhms1.jpg?php echo $row['18'];?>" alt="pimage">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="sidebar-widget mt-5">
                                ...
                                <ul class="property_list_widget">
                                    ...
                                    ?>
                                        <li> <img src="admin/property/zillhms2.jpg?php echo $row['18'];?>" alt="pimage">
